...
Route::prefix('admin')->middleware('admin')->namespace('App\\Http\\Controllers\\Admin')->group(function () {
    ...
    Route::post('edit_department/{id}', 'AdminController@edit_department')->name('admin.edit_department');
        ...
        Route::post('admin/attendance', 'AdminController@admin_attendance')->name('admin.admin_attendance');
...
Route::get('admin/filter_attendance', [PayrollController::class, 'filter_attendance']);
...
Route::get('employee/sick-leave','App\Http\Controllers\SickLeaveController@sick_leave');
Route::get('employee/vacation-leave','App\Http\Controllers\SickLeaveController@vacation_leave');
Route::post('employee/insert_sick_leave','App\Http\Controllers\SickLeaveController@insert_sick_leave');
Route::post('employee/insert_vacation_leave','App\Http\Controllers\SickLeaveController@insert_vacation_leave');
